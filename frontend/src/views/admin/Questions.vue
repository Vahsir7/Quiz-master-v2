      ...
      <div v-for="(question, index) in questions" :key="question.QuestionID" class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="p-4 bg-gray-50 border-b flex justify-between items-start">
          ...
          <div class="space-x-3 flex-shrink-0">
            <button @click="openEditModal(question)" class="text-indigo-600 hover:text-indigo-800" title="Edit Question"><i class="fas fa-pencil-alt"></i></button>
            <button @click="openDeleteModal(question)" class="text-red-600 hover:text-red-800" title="Delete Question"><i class="fas fa-trash-alt"></i></button>
          </div>
        </div>
